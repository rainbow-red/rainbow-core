...
-[x] DatabaseAPI - Provides methods to connect, insert and read data from the database. [Priority: HIGH] <br>
-[x] UserInitialsAPI - Getting Prefix, Suffix, Color from the User. [Priority: MID] <br>
